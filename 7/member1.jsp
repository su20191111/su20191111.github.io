...
<li id="kdhong"><a href="#kd">홍길동 </a></li><Ii id="mrlee"><a href="#mr">이몽룡</a></li> 
<li id="hdbyun"><a href="#hd">변학도</a></li></u1></nav> 
    <section id="Area"><form id="formld"> 
<div id="divl" class="class1"> 
